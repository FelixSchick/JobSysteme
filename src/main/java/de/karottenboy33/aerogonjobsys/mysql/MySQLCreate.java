...
import de.karottenboy33.aerogonjobsys.AerogonJobSys;
...
public class MySQLCreate {
    private static FileConfiguration mysql = AerogonJobSys.mysql;
    ...
    public static void createsTable() {
        try {
            ...
            statement.executeUpdate("CREATE TABLE IF NOT EXISTS job ( `uuid` TEXT, `job` INT, `points` INT, `xp` INT)");
            statement.close();
